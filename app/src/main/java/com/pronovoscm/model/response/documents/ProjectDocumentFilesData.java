...
public class ProjectDocumentFilesData {
    @SerializedName("documentfiles")
    @Expose
    private List<Documentsfile> documentfiles = null;
    ...
    public List<Documentsfile> getDocumentfiles() {
        return documentfiles;
    }

    public void setDocumentfiles(List<Documentsfile> documentsfiles) {
        this.documentfiles = documentsfiles;
    }
