...
public  class UserPermissions {
    ...
    @SerializedName("view-submittal")
    private int viewSubmittal;

    public int getViewSubmittal() {
        return viewSubmittal;
    }

    public void setViewSubmittal(int viewSubmittal) {
        this.viewSubmittal = viewSubmittal;
    }

    @SerializedName("view_issue_tracking")
    private int viewIssueTracking;

    public int getViewIssueTracking() {
        return viewIssueTracking;
    }

    public void setViewIssueTracking(int viewIssueTracking) {
        this.viewIssueTracking = viewIssueTracking;
    }

    @SerializedName("edit_issue_tracking")
    private int editIssueTracking;

    public int getEditIssueTracking() {
        return editIssueTracking;
    }

    public void setEditIssueTracking(int editIssueTracking) {
        this.editIssueTracking = editIssueTracking;
    }

    @SerializedName("delete_issue_tracking")
    private int deleteIssueTracking;

    public int getDeleteIssueTracking() {
        return deleteIssueTracking;
    }

    public void setDeleteIssueTracking(int deleteIssueTracking) {
        this.deleteIssueTracking = deleteIssueTracking;
    }

    @SerializedName("create_issue_tracking")
    private int createIssueTracking;

    public int getCreateIssueTracking() {
        return createIssueTracking;
    }

    public void setCreateIssueTracking(int createIssueTracking) {
        this.createIssueTracking = createIssueTracking;
    }
