...
import com.pronovoscm.utils.SubmittalsFileDownloadProvider;
...
public class SubmittalsDetailsAttachmentAdapter extends RecyclerView.Adapter {
    Activity mActivity;
    List<PjSubmittalAttachments> pjSubmittalAttachments;
    ProjectSubmittalsRepository projectSubmittalsRepository;
    int cornerRadius;
    boolean isOffline;

    public SubmittalsDetailsAttachmentAdapter(Activity activity, List<PjSubmittalAttachments> submittalAttachmentsList, boolean isOffline, ProjectSubmittalsRepository projectSubmittalsRepository) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SubmittalsDetailsAttachmentHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ((SubmittalsDetailsAttachmentHolder) holder).bind(pjSubmittalAttachments.get(position), new OnItemClickListener() {
            @Override
            public void onItemClick(int position, PjSubmittalAttachments pjSubmittalAttachments) {
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, PjSubmittalAttachments pjSubmittalAttachments);
    }

    public class SubmittalsDetailsAttachmentHolder extends RecyclerView.ViewHolder {
        ...
        public SubmittalsDetailsAttachmentHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }

        void bind(PjSubmittalAttachments pjSubmittalAttachments, OnItemClickListener listener) {
                            ...
                            try {
                                new LoadImageInBackground(new LoadImageInBackground.Listener() {
                                    ...
                                    public void onImageDownloaded(Bitmap bitmap) {
                                        ...
                                        projectSubmittalsRepository.updatePjSubmittalAttachments(pjSubmittalAttachments);
                                    }
            ...
            if (pjSubmittalAttachments != null) {
        ...
        public void openFileUri(String url, String fileNameTitle, PjSubmittalAttachments docFile) {
            Log.i("SubmittalAttachmentAdapter", fileNameTitle + "      openFileUri clickImageUrl: " + url);
            try {
        ...
        private void openDocFiles(PjSubmittalAttachments docFile, String url, String fileExt) {
        ...
        private void downLoadPjDocumentFile(PjSubmittalAttachments docFile, ImageView attachmentImageView, boolean fromclick) {
            // open file here
            SubmittalsFileDownloadProvider fileDownloadProvider = new SubmittalsFileDownloadProvider(PronovosApplication.getContext(), projectSubmittalsRepository);
            fileDownloadProvider.getFileFromServer(docFile.getAttachPath(), docFile, new ProviderResult<Boolean>() {
                ...
                public void success(Boolean result) {
                    ...
                    docFile.setSyncStatus(PDFSynEnum.SYNC.ordinal());
                    projectSubmittalsRepository.updatePjSubmittalAttachments(docFile);
                    attachmentProgressBar.setVisibility(View.GONE);
                    attachmentImageView.setVisibility(View.VISIBLE);
