...
public abstract class DayPickerView extends RecyclerView implements DatePickerFragmentDialog.OnDateChangedListener {
    ...
    public DayPickerView(Context context, DatePickerController controller, OnChangeDate onChangeDate) {
        super(context);
        init(context);
        setController(controller, onChangeDate);
    }

    public void setController(DatePickerController controller, OnChangeDate onChangeDate) {
    ...
    //Set orientation of calendar view(vertical or horizontal)
     ...
     * @param onChangeDate
     */
    protected void refreshAdapter(OnChangeDate onChangeDate) {
        if (mAdapter == null) {
            mAdapter = createMonthAdapter(mController, onChangeDate);
        } else {
    ...
    public abstract MonthAdapter createMonthAdapter(DatePickerController controller, OnChangeDate onChangeDate);
