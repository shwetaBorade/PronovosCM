...
public abstract class MonthView extends View {
    ...
    protected static int DEFAULT_HEIGHT = 80;
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller, OnChangeDate onChangeDate) {
        super(context, attr);
        ...
        int heightPixels= (int) (context.getResources().getDisplayMetrics().heightPixels*(0.5));

        mRowHeight = (heightPixels - getMonthHeaderSize()) / MAX_NUM_ROWS;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (onChangeDate != null) {
            onChangeDate.getChangeDate(getMonthString());
            onChangeDate.getChangeYear(getYearString());
        }
    }
    ...
    private String getWeekDayLabel(Calendar day) {
        ...
        return getTwoLetters(weekDayLabelFormatter.format(day.getTime()));
    }
//=====================================================
// For future refrence to change format of day label.
//=====================================================
    public static String getTwoLetters(String threeLetterDay){
