...
@Entity(nameInDb = "Pj_assignee_attachments")
public class PjAssigneeAttachments {
    ...
    @Generated(hash = 1967864182)
    public PjAssigneeAttachments(Long id, String attachPath, Integer attachmentsId,
            ...
            Integer pjSubmittalsId, Integer syncStatus, String type, Date updatedAt,
            Integer usersId) {
        this.id = id;
    ...
    @Generated(hash = 926903749)
    public PjAssigneeAttachments() {
    }
