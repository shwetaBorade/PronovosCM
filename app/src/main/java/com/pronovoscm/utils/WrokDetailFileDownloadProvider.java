...
public class WrokDetailFileDownloadProvider {

    WorkDetailsRepository projectDocumentsRepository;
    private PronovosApplication pronovosApplication;

    public WrokDetailFileDownloadProvider(PronovosApplication pronovosApplication, WorkDetailsRepository projectDocumentsRepository) {
        this.pronovosApplication = pronovosApplication;
        this.projectDocumentsRepository = projectDocumentsRepository;
    }

    public void getFileFromServer(final String location, WorkDetailsAttachments docFile, final ProviderResult<Boolean> providerResult) {
