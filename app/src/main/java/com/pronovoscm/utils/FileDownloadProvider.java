...
public class FileDownloadProvider {
    ...
    public FileDownloadProvider(PronovosApplication pronovosApplication, ProjectDocumentsRepository projectDocumentsRepository) {
        this.pronovosApplication = pronovosApplication;
        this.projectDocumentsRepository = projectDocumentsRepository;
    }

    public void getFileFromServer(final String location, PjDocumentsFiles docFile, final ProviderResult<Boolean> providerResult) {
    ...
    private boolean writeResponseBodyToDisk(ResponseBody body, String fileName) {
        try {
            ...
            File futureStudioIconFile = new File(pronovosApplication.getFilesDir() + Constants.DOCUMENT_FILES_PATH + fileName);
