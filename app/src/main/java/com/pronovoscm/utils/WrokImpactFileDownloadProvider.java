...
public class WrokImpactFileDownloadProvider {

    WorkImpactRepository workImpactRepository;
    private PronovosApplication pronovosApplication;

    public WrokImpactFileDownloadProvider(PronovosApplication pronovosApplication, WorkImpactRepository projectDocumentsRepository) {
        this.pronovosApplication = pronovosApplication;
        this.workImpactRepository = projectDocumentsRepository;
    }

    public void getFileFromServer(final String location, WorkImpactAttachments docFile, final ProviderResult<Boolean> providerResult) {
                    ...
                    call.enqueue(new Callback<ResponseBody>() {
                        ...
                        public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                            if (response.isSuccessful()) {
                                ...
                                workImpactRepository.updateAttachment(docFile);
