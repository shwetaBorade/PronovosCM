...
/**
 * <p>
 * This ViewGroup will have the {@link MyDrawingView} to draw paint on it with {@link ImageView}
...
public class MyPhotoEditorView extends RelativeLayout {

    private static final String TAG = "PhotoEditorView";
    private static final int imgSrcId = 1, brushSrcId = 2, glFilterId = 3;
    private FilterImageView mImgSource;
    private MyDrawingView mBrushDrawingView;
    private ImageFilterView mImageFilterView;

    public MyPhotoEditorView(Context context) {
        super(context);
        init(null);
    }

    public MyPhotoEditorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MyPhotoEditorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public MyPhotoEditorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        //Setup brush view
        mBrushDrawingView = new MyDrawingView(getContext());
...
//        setBrushDrawingMode(true, ToolType.SMOOTHLINE);
    ...
    MyDrawingView getBrushDrawingView() {
