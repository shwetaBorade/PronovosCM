...
public class SubmittalsFileDownloadProvider {

    ProjectSubmittalsRepository projectSubmittalsRepository;
    private PronovosApplication pronovosApplication;

    public SubmittalsFileDownloadProvider(PronovosApplication pronovosApplication, ProjectSubmittalsRepository projectDocumentsRepository) {
        this.pronovosApplication = pronovosApplication;
        this.projectSubmittalsRepository = projectDocumentsRepository;
    }

    public void getFileFromServer(final String location, PjSubmittalAttachments docFile, final ProviderResult<Boolean> providerResult) {
