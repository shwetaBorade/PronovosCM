...
/* DrawingFolderData structures for images (arrays of samples and of DCT coefficients).
...
struct jpeg_decompress_struct {
    ...
    /* DrawingFolderData copied from JFIF marker; only valid if saw_JFIF_marker is TRUE: */
    UINT8 JFIF_major_version;
    /* JFIF version number */
    UINT8 JFIF_minor_version;
    UINT8 density_unit;
...
/* DrawingFolderData destination object for compression */
...
/* DrawingFolderData source object for decompression */
...
#if JPEG_LIB_VERSION >= 80
/* DrawingFolderData source and destination managers: memory buffers. */
