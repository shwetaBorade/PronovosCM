...
public class DispatchFairInsetsRelativeLayout extends RelativeLayout {
    ...
    public DispatchFairInsetsRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DispatchFairInsetsRelativeLayout,
                defStyleAttr, R.style.DispatchFairInsetsRelativeLayout);
