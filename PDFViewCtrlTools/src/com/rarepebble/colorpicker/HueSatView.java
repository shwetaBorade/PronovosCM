...
public class HueSatView extends SquareView implements ObservableColor.Observer {
    ...
    private int colorValueOverlayAlpha = 255;
	...
	public HueSatView(Context context, AttributeSet attrs) {
		...
		borderPath = new Path();
		bitmap = makeBitmap(1);
        colorValueOverlayPaint = new Paint();
        colorValueOverlayPaint.setColor(getResources().getColor(android.R.color.black));
        colorValueOverlayPaint.setAlpha(colorValueOverlayAlpha);
	}
	...
	public void updateColor(ObservableColor observableColor) {
        observableColor.getValue();
        colorValueOverlayAlpha = (int)((1.0f - observableColor.getValue()) * 255);
        colorValueOverlayPaint.setAlpha(colorValueOverlayAlpha);
	...
	protected void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(borderPath, colorValueOverlayPaint);
