// Modified by PDFTron as original cannot be used as-is
// https://github.com/edmodo/cropper/blob/master/cropper/src/com/edmodo/cropper/CropImageView.java
...
public class PTCropImageViewBase extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private static final String TAG = PTCropImageViewBase.class.getName();
    ...
    private PTCropImageViewListener mListener;

    public void setPTCropImageViewListener(PTCropImageViewListener listener) {
        mListener = listener;
    }
