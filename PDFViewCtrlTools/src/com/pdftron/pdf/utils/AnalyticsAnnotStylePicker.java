...
public class AnalyticsAnnotStylePicker {
    ...
    public void setRichTextEnabled(boolean enabled) {
        AnalyticsHandlerAdapter.getInstance().sendEvent(
                AnalyticsHandlerAdapter.EVENT_STYLE_PICKER_OPTIONS,
                AnalyticsParam.stylePickerSelectRichTextParam(enabled, mOpenedFromLocation, mOpenedAnnotation));
        mHasAction = true;
    }
    ...
    public void setEraseInkOnlyEnabled(boolean enabled) {
        AnalyticsHandlerAdapter.getInstance().sendEvent(
                AnalyticsHandlerAdapter.EVENT_STYLE_PICKER_OPTIONS,
                AnalyticsParam.stylePickerSelectEraserParam(enabled, mOpenedFromLocation, mOpenedAnnotation));
        mHasAction = true;
    }
    ...
    public void setPressureSensitiveEnabled(boolean enabled) {
        AnalyticsHandlerAdapter.getInstance().sendEvent(
                AnalyticsHandlerAdapter.EVENT_STYLE_PICKER_OPTIONS,
                AnalyticsParam.stylePickerSelectPressureParam(enabled, mOpenedFromLocation, mOpenedAnnotation));
        mHasAction = true;
    }
