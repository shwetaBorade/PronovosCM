...
public class ShortcutHelper {
    ...
    public static boolean canHandleShortcut(@NonNull ToolManager toolManager, int keyCode, KeyEvent event) {
        return getButtonId(toolManager, keyCode, event) != null;
    }

    @Nullable
    public static DefaultToolbars.ButtonId getButtonId(@NonNull ToolManager toolManager, int keyCode, KeyEvent event) {
        ...
        if (ShortcutHelper.isEraserAnnot(keyCode, event)) {
        ...
        if (ShortcutHelper.isSignatureAnnot(keyCode, event) && !toolManager.isToolModeDisabled(SIGNATURE)) {
            return DefaultToolbars.ButtonId.SIGNATURE;
        }

        if (ShortcutHelper.isImageAnnot(keyCode, event) && !toolManager.isToolModeDisabled(STAMPER)) {
