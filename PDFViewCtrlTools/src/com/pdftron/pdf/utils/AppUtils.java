...
public class AppUtils {
    ...
    public static void initializePDFNetApplication(Context applicationContext, String licenseKey, PDFNetConfig config) throws PDFNetException {
        ...
        File fontCacheFolder = new File(applicationContext.getCacheDir(), FontResource.FONT_FOLDER);
        PDFNet.addResourceSearchPath(fontCacheFolder.getAbsolutePath());
        ...
        String exoticFontPluginPath = config.getExoticFontPluginPath(applicationContext);
    ...
    public static String getLicenseKey(Context applicationContext) {
        return TrialKeyProvider.getLicenseKey(applicationContext);
    }
    ...
    public static void setupPDFViewCtrl(@NonNull PDFViewCtrl pdfViewCtrl, PDFViewCtrlConfig config) throws PDFNetException {
        ...
        pdfViewCtrl.setQuickScaleEnabled(config.isQuickScaleEnabled());
    }
}
