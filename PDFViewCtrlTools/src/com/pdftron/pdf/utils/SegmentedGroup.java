...
// PDFTron team: change updateBackground method to consider right-to-left layout
...
public class SegmentedGroup extends RadioGroup {
    ...
    public SegmentedGroup(Context context) {
        ...
        mTintColor = resources.getColor(R.color.tools_radio_button_selected_color);
    ...
    public void updateBackground() {
        ...
        boolean rtl = Utils.isRtlLayout(getContext());
        if (count > 1) {
            View child = getChildAt(rtl ? count - 1 : 0);
            ...
            updateBackground(getChildAt(rtl ? count - 1 : 0), R.drawable.radio_checked_left, R.drawable.radio_unchecked_left);
            for (int i = 1; i < count - 1; i++) {
                updateBackground(getChildAt(rtl ? count - 1 - i : i), R.drawable.radio_checked_middle, R.drawable.radio_unchecked_middle);
                View child2 = getChildAt(rtl ? count - 1 - i : i);
            ...
            updateBackground(getChildAt(rtl ? 0 : count - 1), R.drawable.radio_checked_right, R.drawable.radio_unchecked_right);
        } else if (count == 1) {
