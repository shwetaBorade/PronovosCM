...
public class ColorPickerGridViewAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (mCustomizeSize) {
                ViewGroup.LayoutParams layoutParams = buttonImageView.getLayoutParams();
                layoutParams.width = mCellWidth;
                layoutParams.height = mCellHeight;
        ...
        if (mSource.get(position).equalsIgnoreCase(TYPE_ADD_COLOR)) {
            ...
            holder.colorButtons.setColorFilter(mTheme.iconColor, PorterDuff.Mode.SRC_IN);
            ...
            if (position == 0) {
                ...
                background.mutate();
                background.setStroke(1, mTheme.iconColor);
...
//            holder.colorImage.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.border_dashed));
            ...
            if (color != Color.TRANSPARENT) {
                GradientDrawable colorSwatch = (GradientDrawable) mContext.getResources().getDrawable(R.drawable.shape_oval);
                colorSwatch.mutate();
                ...
                drawable.setDrawCircle(true);
                holder.colorImage.setBackground(drawable);
            }

            if (mFavoriteList != null && mFavoriteList.contains(colorStr)) {
                int drawableRes = Utils.isColorDark(color, DARK_COLOR_THESHOLD) && color != Color.TRANSPARENT ? R.drawable.ic_star_filled_white_24dp : R.drawable.ic_star_white_border_24dp;
                Drawable icon = getContext().getResources().getDrawable(drawableRes);
