...
public class ToolbarActionMode {
    ...
    @Nullable
    private Toolbar mMainToolbar; // for situation where main toolbar is different from cad toolbar
    ...
    private void show() {
        if (mToolbar != null) {
            if (mEnterAnimation != null) {
                ...
                if (mToolbar.getParent() instanceof ViewGroup) {
                    TransitionManager.beginDelayedTransition((ViewGroup) mToolbar.getParent(), new Fade());
                }
