...
import com.pdftron.pdf.tools.ColorPickerView.OnColorChangedListener;
...
class ColorPanelView extends android.view.View{
    ...
    /**
     * Sets the color that should be shown by this view.
     * @param color
     */
    ...
    /**
     * Gets the color currently show by this view.
     * @return
     */
    int getColor(){
        return mColor;
    ...
    /**
     * Sets the color of the border surrounding the panel.
     * @param color
     */
    ...
    /**
     * Gets the color of the border surrounding the panel.
     */
    int getBorderColor(){
        return mBorderColor;
    }
...
class ColorPickerView extends android.view.View {
    ...
    /**
     * Callback interface to be invoked when the color is changed.
     */
    ...
    private final float[] mOnDrawHsv = new float[3];
    private final RectF mOnDrawRect = new RectF();
    private final Point mOnDrawPoint = new Point();
    private OnColorChangedListener mListener;
    ...
    private void drawHuePanel(Canvas canvas) {
        ...
        mOnDrawRect.set(
            rect.left - RECTANGLE_TRACKER_OFFSET,
            p.y - rectHeight,
            rect.right + RECTANGLE_TRACKER_OFFSET,
            p.y + rectHeight);

        canvas.drawRoundRect(mOnDrawRect, 2, 2, mHueTrackerPaint);
    }
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        mOnDrawHsv[1] = mSat;
        mOnDrawHsv[2] = mVal;
        int color = Color.HSVToColor(mOnDrawHsv);
        int acolor = Color.HSVToColor(0, mOnDrawHsv);
        ...
        if (!Utils.isNullOrEmpty(mAlphaSliderText)) {
        ...
        mOnDrawRect.set(
            p.x - rectWidth,
            rect.top - RECTANGLE_TRACKER_OFFSET,
            p.x + rectWidth,
            rect.bottom + RECTANGLE_TRACKER_OFFSET);
    ...
    private Point hueToPoint(float hue) {
        ...
        mOnDrawPoint.y = (int) (height - (hue * height / 360f) + rect.top);
        mOnDrawPoint.x = (int) rect.left;
    ...
    private Point satValToPoint(float sat, float val) {
        ...
        mOnDrawPoint.x = (int) (sat * width + rect.left);
        mOnDrawPoint.y = (int) ((1f - val) * height + rect.top);
    ...
    private Point alphaToPoint(int alpha) {
        ...
        mOnDrawPoint.x = (int) (width - (alpha * width / 0xff) + rect.left);
        mOnDrawPoint.y = (int) rect.top;
    ...
    /**
     * Sets a OnColorChangedListener to get notified when the color
    ...
    /**
     * Sets the color of the border surrounding all panels.
     *
     * @param color
     */
    void setBorderColor(int color) {
    ...
    /**
     * Gets the color of the border surrounding all panels.
     */
    int getBorderColor() {
        return mBorderColor;
    }
    ...
    /**
     * Gets the current color this view is showing.
     *
    ...
    /**
     * Sets the color the view should show.
     *
    ...
    /**
     * Sets the color this view should show.
     *
     * @param color    The color that should be selected.
    ...
    /**
     * Gets the drawing offset of the color picker view.
    ...
    /**
     * Sets if the user is allowed to adjust the alpha panel. Default is false.
    ...
    /**
     * Sets the text that should be shown in the
     * alpha slider. Sets to null to disable text.
     *
