...
/**
 * A helper <code>Menu</code> class for constructing {@link QuickMenu}
 */
public class QuickMenuBuilder implements Menu, SubMenu {
     ...
     *        changes. Normally use <code>NONE</code> if an item should not be in a
     *        group.
     * @param itemId Unique item ID. Use <code>NONE</code> if you do not need a
     *        unique ID.
     * @param order The order for the item. Use <code>NONE</code> if you do not care
     *        about the order.
     * @param title The text to display for the item.
     * @return The newly added menu item.
     */
     ...
     *<p>
     * <div class="warning">
     * You can only have one level of sub-menus, i.e. you cannot add
     * a subMenu to a subMenu. Exception will be
     * thrown if you try.
     * </div>
     *
     * @param groupId The group identifier that this item should be part of.
     ...
     * @param groupId The group identifier that this item should be part of.
     *        This can also be used to define groups of items for batch state
     *        changes. Normally use <code>NONE</code> if an item should not be in a group.
     * @param itemId Unique item ID. Use <code>NONE</code> if you do not need a unique ID.
     * @param order The order for the item. Use <code>NONE</code> if you do not care about the
     *        order.
     * @param titleRes Resource identifier of title string.
     * @return The newly added sub-menu
     */
    ...
    /**
     * Gets the <code>MenuItem</code> that represents this submenu in the parent
     * menu.  Use this for setting additional item attributes.
     *
     * @return The <code>MenuItem</code> that launches the submenu when invoked.
     */
    @Override
