...
public class AnnotEditAdvancedShape extends AnnotEdit {
    ...
    public AnnotEditAdvancedShape(@NonNull PDFViewCtrl ctrl) {
        ...
        //TODO 07/14/2021 Gwl update  Disable Movement on others drawn it Start
        Log.d("Edit AdvanceShape", "AnnotEditAdvancedShape: " + mAnnot);
        if (mAnnot != null)
            try {
        ...
        //TODO 07/14/2021 Gwl update  Disable Movement on others drawn it End
