...
public abstract class AdvancedShapeCreate extends SimpleShapeCreate {
    ...
    protected ArrayList<Point> mPagePoints = new ArrayList<>();
    ...
    public interface OnEditToolbarListener {
         ...
         */
        void showEditToolbar(@NonNull ToolMode toolMode, @Nullable Annot annot, int pageNum);
    ...
    private void showEditToolbar() {
        ...
        if (!mIsEditToolbarShown) {
            ...
            if (mOnEditToolbarListener != null) {
                ...
                mOnEditToolbarListener.showEditToolbar(toolMode, null, 0);
            }
        }
    ...
    public boolean onDown(MotionEvent e) {
        ...
        double[] pts = mPdfViewCtrl.convScreenPtToPagePt(snapPoint.x, snapPoint.y, mPageNum);
        Point pagePoint;
