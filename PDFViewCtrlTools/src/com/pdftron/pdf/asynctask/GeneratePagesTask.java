...
public class GeneratePagesTask extends AsyncTask<Void, Void, Boolean> {
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            } else if (mPageType == AddPageDialogFragment.PageType.Dotted) {
                doc = PDFDocGenerator.generateDottedPaperDoc(width, height, 0.25, 2.0, lineShade, lineShade, lineShade, bgR, bgG, bgB);
            } else if (mPageType == AddPageDialogFragment.PageType.IsometricDotted) {
                doc = PDFDocGenerator.generateIsometricDottedPaperDoc(width, height, 0.25, 2.0, lineShade, lineShade, lineShade, bgR, bgG, bgB);
            }
