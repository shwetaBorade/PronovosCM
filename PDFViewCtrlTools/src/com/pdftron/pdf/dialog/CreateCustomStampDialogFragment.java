...
public class CreateCustomStampDialogFragment extends CustomSizeDialogFragment implements CreateBitmapFromCustomStampTask.OnCustomStampCreatedCallback {
    ...
    private ActionButton mPointingLeftImage, mPointingRightImage, mRoundedRectangleImage;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mPointingLeftImage.setIcon(context.getResources().getDrawable(R.drawable.ic_stamp_left_black_24dp));
        mPointingLeftImage.setIconColor(theme.iconColor);
        mPointingLeftImage.setSelectedIconColor(theme.iconColor);
        mPointingLeftImage.setSelectedBackgroundColor(theme.selectedBackgroundColor);
        mPointingLeftImage.setCheckable(true);
        mPointingLeftImage.setShowIconHighlightColor(false);
        ...
        mPointingRightImage.setIcon(context.getResources().getDrawable(R.drawable.ic_stamp_right_black_24dp));
        mPointingRightImage.setIconColor(theme.iconColor);
        mPointingRightImage.setSelectedIconColor(theme.iconColor);
        mPointingRightImage.setSelectedBackgroundColor(theme.selectedBackgroundColor);
        mPointingRightImage.setCheckable(true);
        mPointingRightImage.setShowIconHighlightColor(false);
        ...
        mRoundedRectangleImage.setIcon(context.getResources().getDrawable(R.drawable.ic_stamp_rounded_black_24dp));
        mRoundedRectangleImage.setIconColor(theme.iconColor);
        mRoundedRectangleImage.setSelectedIconColor(theme.iconColor);
        mRoundedRectangleImage.setSelectedBackgroundColor(theme.selectedBackgroundColor);
        mRoundedRectangleImage.setCheckable(true);
        mRoundedRectangleImage.setShowIconHighlightColor(false);
    ...
    static final class Theme {
        ...
        public Theme(int iconColor, int selectedBackgroundColor) {
            this.iconColor = iconColor;
            this.selectedBackgroundColor = selectedBackgroundColor;
        }

        public static CreateCustomStampDialogFragment.Theme fromContext(@NonNull Context context) {

            final TypedArray a = context.obtainStyledAttributes(
                    null, R.styleable.CreateStampDialogTheme, R.attr.pt_create_stamp_dialog_style, R.style.PTCreateStampDialogTheme);

            int iconColor = a.getColor(R.styleable.CreateStampDialogTheme_iconColor, context.getResources().getColor(R.color.annot_toolbar_icon));
            int selectedBackgroundColor = a.getColor(R.styleable.CreateStampDialogTheme_selectedBackgroundColor, context.getResources().getColor(R.color.annot_toolbar_selected_background));
            a.recycle();

            return new CreateCustomStampDialogFragment.Theme(iconColor, selectedBackgroundColor);
        }
    }
}
