    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragment.setStyle(DialogFragment.STYLE_NORMAL, mTheme != 0 ? mTheme : R.style.PDFTronAppTheme);
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                if (mActionMode == null) {
                    if (mOnCustomStampSelectedListener != null) {
                        String customStampsInfo = "";
                        Obj stampObj = CustomStampOption.getCustomStampObj(view.getContext(), position);
                        try {
                            JSONObject jsonObject = new JSONObject();
                            jsonObject.put(CustomStampOption.KEY_INDEX, position);
                            customStampsInfo = jsonObject.toString();
                        } catch (Exception ignored) {}
                        mOnCustomStampSelectedListener.onCustomStampSelected(customStampsInfo, stampObj);
                    }
                } else {
