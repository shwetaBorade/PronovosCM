...
public class SimpleDateTimePickerFragment extends DialogFragment {
    ...
    public static final String TAG = SimpleDateTimePickerFragment.class.getName();
    ...
    public interface SimpleDatePickerListener {
        ...
        void onClear();
        void onDismiss(boolean manuallyEnterValue, boolean dismissedWithNoSelection);
    }
    ...
    public static SimpleDateTimePickerFragment newInstance(@DialogMode final int mode) {
        return newInstance(mode, true);
    }

    public static SimpleDateTimePickerFragment newInstance(@DialogMode final int mode, final boolean allowEnterValue) {
        SimpleDateTimePickerFragment fragment = new SimpleDateTimePickerFragment();
        Bundle args = new Bundle();
        args.putInt(BUNDLE_MODE, mode);
        args.putBoolean(BUNDLE_ALLOW_ENTER_VALUE, allowEnterValue);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        int mode = MODE_DATE;
        boolean allowEnterValue = true;
        if (getArguments() != null) {
            mode = getArguments().getInt(BUNDLE_MODE, MODE_DATE);
            allowEnterValue = getArguments().getBoolean(BUNDLE_ALLOW_ENTER_VALUE, true);
        }
        ...
        if (allowEnterValue) {
            dialog.setButton(DialogInterface.BUTTON_NEGATIVE, getString(R.string.clear), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    mDismissedWithNoSelection = false;
                    if (mListener != null) {
                        mListener.onClear();
                    }
                }
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        if (mListener != null) {
            mListener.onDismiss(mManuallyEnterValue, mDismissedWithNoSelection);
        }
    }
