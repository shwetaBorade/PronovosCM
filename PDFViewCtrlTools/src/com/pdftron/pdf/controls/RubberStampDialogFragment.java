...
public class RubberStampDialogFragment extends CustomSizeDialogFragment {
    ...
    private final static String BUNDLE_HAS_TARGET_POINT = "has_target_point";
    ...
    public static RubberStampDialogFragment newInstance(@Nullable PointF targetPoint, StandardStampPreviewAppearance[] standardStampPreviewAppearance, CustomStampPreviewAppearance[] customStampPreviewAppearances) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (arg != null) {
            boolean hasTargetPoint = arg.getBoolean(BUNDLE_HAS_TARGET_POINT);
            if (hasTargetPoint) {
