...
public class EditToolbar extends InsectHandlerToolbar implements BaseEditToolbar {
    ...
    /**
     * Callback to update {@link EditToolbar} on orientation changes.
     */
    ...
    private void init(@NonNull Context context,
        ...
        try {
            mBackgroundColor = typedArray.getColor(R.styleable.EditToolbar_colorBackground, Color.BLACK);
            mToolBackgroundColor = typedArray.getColor(R.styleable.EditToolbar_colorToolBackground, Color.BLACK);
            mToolIconColor = typedArray.getColor(R.styleable.EditToolbar_colorToolIcon, Color.WHITE);
            mCloseIconColor = typedArray.getColor(R.styleable.EditToolbar_colorCloseIcon, Color.WHITE);
        } finally {
            typedArray.recycle();
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mOnEditToolbarChangeListener != null) {
            mOnEditToolbarChangeListener.onOrientationChanged();
        }
    }
    ...
    public void setOnEditToolbarChangeListener(OnEditToolbarChangedListener listener) {
        mOnEditToolbarChangeListener = listener;
    }
}
