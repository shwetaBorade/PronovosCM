 ...
 */
public class FavoriteColorDialogFragment extends CustomSizeDialogFragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mToolbar.inflateMenu(R.menu.annot_style_picker_favorite_toolbar);
        mDoneButton = mToolbar.getMenu().findItem(R.id.done);
        mDoneButton.setVisible(false);
        mToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == mDoneButton.getItemId()) {
                    onDoneButtonClicked();
                    dismiss();
                }
                return false;
        ...
        mPresetColors.setShowAllColors(true);
        ...
        if (getArguments() != null) {
            ...
            if (getArguments().containsKey(FAVORITE_DIALOG_MODE)) {
                ...
                if (mDialogMode == EDIT_COLOR) {
                    mToolbar.setTitle(R.string.controls_fav_color_editor_edit_color);
