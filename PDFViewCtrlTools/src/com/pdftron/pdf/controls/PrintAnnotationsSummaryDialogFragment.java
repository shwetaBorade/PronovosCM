...
public class PrintAnnotationsSummaryDialogFragment extends DialogFragment {
    ...
    public interface PrintAnnotationsSummaryListener {
        void onConfirmPrintAnnotationSummary(boolean documentChecked, boolean annotationsChecked, boolean summaryChecked);
    }
    ...
    private boolean mDocumentChecked, mAnnotationsChecked, mSummaryChecked;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (args != null) {
            mDocumentChecked = args.getBoolean(DOCUMENT_CHECKED, true);
            mAnnotationsChecked = args.getBoolean(ANNOTATIONS_CHECKED, true);
            mSummaryChecked = args.getBoolean(SUMMARY_CHECKED, false);
        }
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        CheckBox checkBoxDocument = view.findViewById(R.id.check_box_document);
        ...
        mCheckBoxAnnots = view.findViewById(R.id.check_box_annots);
        ...
        CheckBox checkBoxSummary = view.findViewById(R.id.check_box_summary);
        ...
        builder.setPositiveButton(R.string.ok,
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (mPrintAnnotationsSummaryListener != null) {
                            mPrintAnnotationsSummaryListener.onConfirmPrintAnnotationSummary(mDocumentChecked, mAnnotationsChecked, mSummaryChecked);
                        }
                    }
                });
    ...
    public void setPrintAnnotationsSummaryListener(PrintAnnotationsSummaryListener listener) {
        mPrintAnnotationsSummaryListener = listener;
    }
