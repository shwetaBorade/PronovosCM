...
public class CustomStampOption {
    ...
    synchronized public static void removeCustomStamps(@Nullable Context context, @NonNull List<Integer> indexes) {
        ...
        for (int j = indexes.size() - 1; j >= 0; --j) {
            ...
            // let's first delete the file to be deleted
            String path = getCustomStampBitmapPath(context, index);
    ...
    public static String getCustomStampBitmapPath(@NonNull Context context, int index) {
    ...
    @Nullable
    public static String getCustomStampsInfo(@NonNull Context context) {
