...
public class StandardStampOption extends CustomStampOption {
    ...
    private final static String FILE_STANDARD_STAMP_BITMAP_CACHE = "standard_stamp_bitmap_";
    ...
    public static String getStandardStampBitmapPath(@NonNull Context context, @NonNull String name) {
        return context.getFilesDir().getAbsolutePath() + File.separator + FILE_STANDARD_STAMP_BITMAP_CACHE + name + ".png";
    }
    ...
    public static void clearCache(@NonNull Context context) {
        ...
        for (File file : files) {
            if (file.getName().startsWith(FILE_STANDARD_STAMP_BITMAP_CACHE) ||
                    file.getName().startsWith(FILE_STANDARD_STAMP_INFO)) {
