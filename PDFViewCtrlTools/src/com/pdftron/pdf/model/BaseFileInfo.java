...
public interface BaseFileInfo {
    ...
    /**
     * @return header text of file (e.g. Earlier / Past Week)
     */
    String getHeaderText();

    /**
     * @return check if filetype is a header
     */
    boolean isHeader();

    /**
     * @return check if type is specifically "Today" on Recent List
     */
    boolean isTodayHeading();

    /**
     * @return check if type is specifically "Past Week" on Recent List
     */
    boolean isThisWeekHeading();


    /**
     * @return check if type is specifically "Earlier" on Recent List
     */
    boolean isEarlierHeading();

    /**
     * @return the timestamp of the lastModified date
     */
