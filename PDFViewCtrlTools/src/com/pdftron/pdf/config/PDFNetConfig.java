...
public class PDFNetConfig {
    ...
    private static final String EXOTIC_FONT_PLUGIN_NAME = "pdftron_exotic_font_resources.plugin";
     ...
     * @return folder path
     */
    public String getExoticFontPluginPath(Context applicationContext) {
        try {
            Utils.copyResourceToTempFolder(applicationContext,
                    R.raw.pdftron_exotic_font_resources, false, EXOTIC_FONT_PLUGIN_NAME);
        } catch (Exception e) {
            Log.e(TAG, e.getMessage());
        }
        return null;
