...
public class CalendarProperties {
    ...
    private int mCalendarType, mHeaderColor, mHeaderLabelColor, mSelectionColor, mTodayLabelColor, mTodayColor, mDialogButtonsColor, mItemLayoutResource, mDisabledDaysLabelsColor, mHighlightedDaysLabelsColor, mPagesColor, mAbbreviationsBarColor, mAbbreviationsLabelsColor, mDaysLabelsColor, mSelectionLabelColor, mAnotherMonthsDaysLabelsColor, mHeaderVisibility, mNavigationVisibility, mAbbreviationsBarVisibility, mMaximumDaysRange;
    ...
    public void setHighlightedDays(List<Calendar> highlightedDays) {
        mHighlightedDays = Stream.of(highlightedDays).map(calendar -> {
            DateUtils.setMidnight(calendar);
            return calendar;
        }).toList();
    }
    ...
    public void setSelectedDays(List<Calendar> selectedDays) {
        ...
        }).filterNot(value -> mDisabledDays.contains(value.getCalendar())).toList();
    }
    ...
    public void setSelectedDayOnclick(Calendar calendar) {
