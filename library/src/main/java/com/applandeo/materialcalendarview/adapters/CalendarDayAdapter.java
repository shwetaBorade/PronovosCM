...
class CalendarDayAdapter extends ArrayAdapter<Date> {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        dayLabel.setText(String.valueOf(day.get(Calendar.DAY_OF_MONTH)));
          ...
          selectedDate = sdformat.format(mCalendarProperties.getSelectedDay()!=null?mCalendarProperties.getSelectedDay().getTime():Calendar.getInstance().getTime());
        String dayDate = sdformat.format(day.getTime());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            if (mCalendarProperties != null && selectedDate.equals(dayDate)) {
                dayLabel.setBackground(ContextCompat.getDrawable(dayLabel.getContext(), R.drawable.background_color_circle_selected));
                dayLabel.setTextColor(ContextCompat.getColor(dayLabel.getContext(), android.R.color.white));
            }
        }
        return view;
    }
